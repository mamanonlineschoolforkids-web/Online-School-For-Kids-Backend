...
public class GetChildNotificationPreferencesQuery : IRequest<NotificationPreferences>
{
...
public class GetChildNotificationPreferencesCommandHandler
    : IRequestHandler<GetChildNotificationPreferencesQuery, NotificationPreferences>
{
    ...
    public async Task<NotificationPreferences> Handle(
        GetChildNotificationPreferencesQuery request,

...
public class GetSocialLinksCommand : IRequest<List<SocialLinkDto>>
{
    public string UserId { get; set; } = string.Empty;
}

public class GetSocialLinksCommandHandler : IRequestHandler<GetSocialLinksCommand, List<SocialLinkDto>>
{
    ...
    public async Task<List<SocialLinkDto>> Handle(GetSocialLinksCommand request, CancellationToken cancellationToken)
    {
